...
const PaymentGatewy = () => {
    ...
    const {senderName,email,senderPhone,cost}=paymentInfo;
    ...
    return (
        <div className={classes.root}>
            <div className={classes.main}>
                 ...
                 <h4 style={{margin:'12px 0px'}}>Name:<span style={{float:'right',marginLeft:'150px'}}>{senderName}</span> </h4><hr />
                 <h4 style={{margin:'12px 0px'}}>Email:<span style={{float:'right',marginLeft:'150px'}}>{email}</span></h4><hr />
                 <h4 style={{margin:'12px 0px'}}>Phone:<span style={{float:'right',marginLeft:'150px'}}>{senderPhone}</span></h4><hr />
