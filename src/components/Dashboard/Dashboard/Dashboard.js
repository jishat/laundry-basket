...
import CourierProduct from '../CourierProduct/CourierProduct';
import CorurierHistory from '../CourierHistory/CourierHistory';
...
const Dashboard = () => {
    ...
    const history=useHistory();
        useEffect(()=>{
            fetch("https://warm-badlands-71621.herokuapp.com/isAdmin", {
                method: "POST",
            ...
            .then(result=>{
                setIsAdmin(result);
                result?setSelectedOption("Courier Orders"):setSelectedOption("Courier Product");
                })
        },[])
        const handleExit=()=>{
            setLoggedInUser({});
                ...
                <Grid style={{paddingLeft:'30px',paddingTop:'1px'}} container maxWidth="lg">
                    ...
                    <Grid item xs={12} md={9}>
                            ...
                            <Switch>
                                ...
                                <Route path="/courierProduct">
                                   <CourierProduct></CourierProduct>
                                </Route>
                                <Route path="/courierHistory">
                                   <CorurierHistory></CorurierHistory>
                                </Route>
                                <Route path="/review">
                                   <Review></Review>
                                </Route>
                                ...
                                <Route exact path="/dashboard">
                                   {isAdmin?<Orders></Orders>:<CourierProduct></CourierProduct>}
                                </Route>
